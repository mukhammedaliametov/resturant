...
const Hero = () => {
  return (
    <div className="container my-[30px]">
      <div className="hero-gradient rounded-[30px] py-[28px] md:py-[40px] min-h-[20vh] md:min-h-[100vh] mx-[25px] pb-[5px] md:pb-[10px]">
        <Header />
        <div className="w-[83%] md:w-[90%] mx-auto flex flex-col md:flex-row items-center justify-between my-[60px] relative">
          <div className="flex justify-center items-center md:items-baseline flex-col md:justify-left text-center md:text-left ">
            <h1 className="text-[32px] md:text-[64px] font-[900] uppercase mb-[30px] w-[320px] md:w-[420px]">
          ...
          <div className="hidden md:block">
            <img
              src={Leaf1}
              alt="leaf1"
              className="absolute left-[181.33px] md:left-[350px] top-0 rotate-142 w-[200px]"
            />
            <img
              src={Leaf2}
              alt="leaf2"
              className="absolute left-[325px] md:left-[422px] top-[372px] w-[200px]"
            />
            <img
              src={Leaf3}
              alt="leaf3"
              className="absolute left-[-73px] md:left-[903px] w-[200px]"
            />
            <img
              src={Leaf3}
              alt="leaf3"
              className="absolute left-[-23px] md:left-[-150px] top-[-50px] w-[200px]"
            />
          </div>
        </div>
      </div>
